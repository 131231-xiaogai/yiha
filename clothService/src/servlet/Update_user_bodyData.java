...
public class Update_user_bodyData extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public Update_user_bodyData() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("修改用户参数的用户ID ："+user_id);
		
		Message me=new Message();
		
		try {
			if(ConsumerDao.update_user_bodyData( 
					 user_id,
					 weight,
					 height,
					 bust,
					 ...
					 trousers_length)){
				me.setCode(200);
				me.setMessage("保存修改用户参数成功！");
				me.setData(null);
			}else{
				me.setCode(-11);//返回给前端程序代码
				me.setMessage("保存修改用户参数失败，请重试。");//返回给用户看
				me.setData(null);
