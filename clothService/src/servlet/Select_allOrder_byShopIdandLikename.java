...
public class Select_allOrder_byShopIdandLikename extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public Select_allOrder_byShopIdandLikename() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("店铺"+shop_id+"查询订单内容"+good_name);
		...
		try {
			List<OrderBean> orderBeans = OrderDao.select_allOrder_byShopIdandLikename(shop_id,good_name);
