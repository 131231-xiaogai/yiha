...
public class Select_order_byUseridAndOrderStstus_likeName extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public Select_order_byUseridAndOrderStstus_likeName() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("用户"+user_id+"查询订单内容"+good_name);
		...
		try {
			List<OrderBean> orderBeans = OrderDao.select_order_byUseridAndOrderStstus_likeName(user_id,order_status,good_name);
