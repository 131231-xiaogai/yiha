...
public class Update_user_addressServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public Update_user_addressServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			if(AddressDao.update_user_address(address_id, contact_name,contact_phone,address_total,address_detail)){
				me.setCode(200);
				me.setMessage("保存成功！");
				me.setData(null);
			}else{
