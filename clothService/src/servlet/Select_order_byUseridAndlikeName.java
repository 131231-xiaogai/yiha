...
public class Select_order_byUseridAndlikeName extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public Select_order_byUseridAndlikeName() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("店铺"+user_id+"查询订单内容"+good_name);
		...
		try {
			List<OrderBean> orderBeans = OrderDao.select_order_byUseridAndlikeName(user_id,good_name);
