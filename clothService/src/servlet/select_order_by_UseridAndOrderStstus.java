...
public class select_order_by_UseridAndOrderStstus extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public select_order_by_UseridAndOrderStstus() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			List<OrderBean> orderBeans = OrderDao.select_order_by_UseridAndOrderStstus(user_id, order_status);
