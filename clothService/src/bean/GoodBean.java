...
public class GoodBean {
	...
	public void setTrousers_length(String trousers_length) {
		this.trousers_length = trousers_length;
	}
	...
	public String getActivility_id() {
		return activility_id;
	}
	public void setActivility_id(String activility_id) {
		this.activility_id = activility_id;
	}
